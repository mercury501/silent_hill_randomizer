...
impl data_structs::MyApp {
    ...
    fn probs_ui(&mut self, ui: &mut egui::Ui, _frame: &mut eframe::Frame) {
        ...
        ui.horizontal(|ui| {
            ui.vertical(|ui| {
                ...
                ui.add(
                    egui::Slider::new(self.sh3_sliders[index].main_mut(), 0..=100)
                        .text(&self.sh3_perc_strings.main_str[index]),
                );
                ...
                ui.add(
                    egui::Slider::new(&mut self.sh3_sliders[index].option_one, 0..=100)
                        .text(&self.sh3_perc_strings.option_one_str[index]),
                );
                ...
                ui.add(
                    egui::Slider::new(&mut self.sh3_sliders[index].option_two, 0..=100)
                        .text(&self.sh3_perc_strings.option_two_str[index]),
                );
                ...
                ui.add(
                    egui::Slider::new(&mut self.sh3_sliders[index].option_three, 0..=100)
                        .text(&self.sh3_perc_strings.option_three_str[index]),
                );
                ...
                ui.add(
                    egui::Slider::new(&mut self.sh3_sliders[index].option_four, 0..=100)
                        .text(&self.sh3_perc_strings.option_four_str[index]),
                );
    ...
    fn info_ui(&mut self, ui: &mut egui::Ui) {
        ui.vertical(|ui| {
            ...
            if ui.button("Add 5 health drinks").clicked() {
                let mut current_drinks = mem_mgmt::read_u8(self.sh3_process_id, 0x0712CAB2);
                current_drinks += 5;
                let mut data_vec: Vec<u8> = Vec::new();
                data_vec.push(current_drinks);
                if !(current_drinks >= 255) {
                    mem_mgmt::write_byte_to_addr(self.sh3_process_id, &data_vec, 0x0712CAB2);
                }
            }
        });
    }
    ...
    pub fn bottom_ui(&mut self, ui: &mut egui::Ui) {
        ui.horizontal(|ui| {
            if ui.button("Update Probs").clicked() {
                ...
                self.high_score = mem_mgmt::read_highscore(self.sh3_process_id) as i32;
                self.bonus_points = mem_mgmt::read_bonus(self.sh3_process_id);
                self.health_drinks = mem_mgmt::read_u8(self.sh3_process_id, 0x0712CAB2);
            }
    ...
    pub fn bottom_probs_ui(&mut self, ui: &mut egui::Ui, frame: eframe::egui::Frame) {
                ui.horizontal(|ui| {
                    if ui.button("Update Probs").clicked() {
                        self.set_probability();
                        self.high_score = mem_mgmt::read_highscore(self.sh3_process_id) as i32;
