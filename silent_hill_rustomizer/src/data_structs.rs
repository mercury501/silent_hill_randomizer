...
impl Default for MyApp {
    fn default() -> Self {
        Self {
            ...
            sh2_regions: [
                0x000000, 0x8F18A0, 0x8EAB50, 0x8EA718, 0x8EA208, 0x8EA208, 0x8E65D0, 0x8E5A58,
                0x8E41A8, 0x8E3AC0, 0x8E30F8, 0x8E2708, 0x8E1F08, 0x8E1698, 0x8E08F0, 0x8DD888,
                0x8DD380, 0x8DD238, 0x8DCD48, 0x8DC180, 0x8DB288, 0x8DA7D0, 0x8D9D68, 0x8D9798,
                0x8D9218, 0x8D8CA8, 0x8D8130, 0x8D7870, 0x8D7620, 0x8D7318, 0x8D6ED8, 0x8D61E8,
                0x8D5408, 0x8D4918, 0x8D4140, 0x8D2F00, 0x8D1FA8, 0x8CFCC8, 0x8CF618, 0x8CF310,
                0x8CE9C8, 0x8CD0A0, 0x8CBE78, 0x8CB8F0, 0x8CAEC8, 0x8CA668, 0x8C9ED0, 0x8C9A58,
    ...
    fn sh3_inject_values(&mut self) {
        ...
        for offset in 0..40 {
            ...
            loop {
                ...
                if (self.sh3_randomizable_type_id.contains(&type_id)
                    && self.can_randomize_gid(&gid))
                {
                    random_mob = self.sh3_prob_map.choose(&mut rng).unwrap();

                    #[cfg(debug_assertions)]
                    println!(
                        "Writing id {:#04x}, opt {:#04x}",
                        random_mob.type_id, random_mob.option_id
                    );
